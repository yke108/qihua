    ...
    <el-row>
      <el-col :span="24">
        ...
        <el-table :data="tableData" border style="width: 100%">
          <el-table-column prop="orderId" label="ID" width="80"></el-table-column>
          <el-table-column prop="orderSn" label="OrderSn" width="150"></el-table-column>
          ...
          <el-table-column prop="stateName" label="State" width="130"></el-table-column>
          <el-table-column prop="adminName" label="Inquiry Assign" width="130"></el-table-column>
          <el-table-column prop="adminName" label="Order Assign" width="130"></el-table-column>
          <el-table-column label="Action">
            <template scope="scope">
              <router-link :to="{ name: 'EditOrder', params: { id: scope.row.orderId }}"><el-button type="primary" size="small">Modify</el-button></router-link>
              <router-link :to="{ name: 'OrderDetail', params: { id: scope.row.orderId }}"><el-button type="primary" size="small">View</el-button></router-link>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
  ...
  export default {
    ...
    methods: {
      ...
      loadData: function() {
        ...
        let _this = this;
        getOrderList(pdt).then(response => {
