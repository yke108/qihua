      ...
      <el-col :span="24">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="status">
            <el-select v-model="criteria.state" placeholder="">
              <el-option
          ...
          <router-link :to="{ name: 'Add product', params: { id: '0' }}"><el-button type="success" style="float: right;"><i class="el-icon-plus"></i> Add Product</el-button></router-link>
        </el-form>
        <!--表格-->
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column label="Action" width="180">
            <template scope="scope">
              <router-link :to="{ name: 'Add product', params: { id: scope.row.id }}"><el-button type="primary" size="small">Modify</el-button></router-link>
              <el-button v-if="scope.row.state === '1'" type="danger" size="small" @click="handleAudit(scope.$index, scope.row)">Unshelve</el-button>
              <el-button v-else type="danger" size="small" @click="handleAudit(scope.$index, scope.row)">Valid</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
