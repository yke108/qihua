...
//    'DEFAULT_MODULE'       =>    'Home',
    ...
    // 自营商家信息
    'SELF_SUPPORT_INFO' => array(
        'NAME' => 'Keywa', 
        'COMPANY_NAME' => 'Guangdong Keywa Chemical Trading Center Co., Ltd.', 
        'TEL' => '0757-63812329',
        'EMAIL' => 'qihua@keywa.com',
        'FAX' => '0757-63812328',
        'MOBILE' => '13106203802',
        'COUNTRY' => 'China',
        'REGION' => 'Mainland',
        'CITY' => 'Guang Zhou',
        'ADDRESS' => 'No.128 Huangpu East Road, Tianhe District, Guangzhou, Guangdong, China',
    ),

    // 单位
    'WEIGHTUNIT' => [
        '1' => ['id' => '1', 'name' => 'ton', 'packWeight' => 1000],
        '2' => ['id' => '2', 'name' => 'Kg', 'packWeight' => 1],
        '3' => ['id' => '3', 'name' => 'g', 'packWeight' => 0.001],
        '4' => ['id' => '4', 'name' => 'Bag', 'packWeight' => 0],
        '5' => ['id' => '5', 'name' => 'Drum', 'packWeight' => 0],
    ],
    // 付款条款
    'PROVISION' => [
        '1' => ['id' => '1', 'name' => 'FOB'],
