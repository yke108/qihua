...
class MemberModel extends Model{
    ...
    protected $_validate = array(
        ...
        array('password','require','Password is empty'),
        ...
        array('repassword', 'password', 'Your confirmed password and password do not match!', 0, 'confirm'), // 验证确认密码是否和密码一致
...
//        array('captcha','checkverify','验证码错误',0,'callback'),
   ...
   */
     ...
     * @return int
     */
    public function checkSendEmailRate($email, $random, $time=1800) {
        $redis =  \Think\Cache::getInstance('Redis');
